...
public class Rat extends GraphicsItem {
    ...
    public void escapeFrom_(Snake snake) {
        // get the current point and generate a new one
        // by calculations not by coping a whole array of possible positions

        // get a number not a Point2D and calculate the point from it
        // e.g. point no. 3
        // Point2D = Point2D((3 % w) * Config.partW, (3/h) * Config.partH)
    }
